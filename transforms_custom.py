...
from torchvision.transforms import ColorJitter, Compose as TorchCompose

class ColorJitterEffDet:
...
def transforms_coco_train(
    ...
    if color_jitter and color_jitter > 0:
        ...
        print("Added ColorJitter with factor:", color_jitter)
    
    image_tfl.append(RandomFlip(horizontal=True, prob=0.5))
